...
(define (print-queue queue)
  (define element-list (front-ptr queue))
...
;;; Signal propagation and probes
;; Text assumes a global agenda rather than passing it around. Staaaaaate!
...
(probe 'output output)
(log-with-time "created wires and and-gate")
